...
alias hnorm='norminette -R CheckDefine'
alias wgcc='gcc -Wall -Wextra -Werror'
alias show_norm='alias | grep "norm"'
alias space='~/42toolbox/./free_space.sh'
alias rmc='rm -r ~/Library/Caches/*; rm ~/.zcompdump*; brew cleanup'
